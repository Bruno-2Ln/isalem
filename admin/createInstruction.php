        ...
        if (isset($_SESSION['admin_id'])){
            ...
            if (isset($admin)){
                ...
                if ($admin->roles_admin === 1){
                    ...
                    echo displayHeader('Création Instruction');
            ...
            <div class="container-divs">
                ...
                <div class="container div-hover div-form mt-2 pb-5">
                    <form method="POST" action="../process/tr_createInstruction.php">
        
                        <div class="form-group"> 
                            <label>Ordre d'apparition</label>
                            <input type="number" name="orderOfAppearance" class="form-control" required pattern="^[1-9]">
                        </div>
                
                        <div class="form-group">
                            <label>Contenu</label>
                            <textarea name="content" class="form-control textarea-content" cols="30" rows="10" required></textarea>
                        </div>

        ...
        if (isset($_SESSION['admin_id'])){
            ...
            if (isset($admin)){
                ...
                if ($admin->roles_admin === 1){
                    ...
                    echo displayHeader('Création Admin');
            ...
            <div class="container-divs-update-and-create">
                ...
                <div class="container div-hover div-form mt-2 pb-5">
                    <form method="POST" action="../process/tr_signUp.php">
                        ...
                        <div class="form-group">
                            <label>Rôle</label>
                            <select name="roles_admin" class="form-control" id="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="mail" name="email" class="form-control" value="<?php echo $_SESSION['email']?>" required>
                        </div>
